...
IBM850::IBM850() : Charset("ISO-8859-2") {}

IBM850 IBM850::INSTANCE{};

String IBM850::name() const {
    return "ISO-8859-2";
}

Charset::ErrorAction IBM850::malformedAction() const {
    return Charset::malformedAction();
}

Charset::ErrorAction IBM850::unmappableAction() const {
    return Charset::unmappableAction();
}

Charset::CoderResult IBM850::decodeLoop(ByteBuffer &src, CharBuffer &dst) {
...
Charset::CoderResult IBM850::encodeLoop(CharBuffer &src, ByteBuffer &dst) {
    struct Surrogate {
        gint& errorLength;
        gint isPair = false;
...
gfloat IBM850::averageCharsPerByte() const {
    return 1.0f;
}

gfloat IBM850::averageBytesPerChar() const {
    return 1.0f;
}

CharBuffer IBM850::decode(ByteBuffer &in) {
    return Charset::decode(in);
}

ByteBuffer IBM850::encode(CharBuffer &in) {
    return Charset::encode(in);
}

String IBM850::toString() const {
    return Charset::toString();
}

gbool IBM850::contains(const Charset &cs) const {
    return dynamic_cast<IBM850 const *>(&cs);
}

gbool IBM850::canEncode(gchar c) const {
    return Charset::canEncode(c);
}

Object &IBM850::clone() const {
    return INSTANCE;
}
