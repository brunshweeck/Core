...
ISO8859_13::ISO8859_13() : Charset("ISO-8859-13") {}

ISO8859_13 ISO8859_13::INSTANCE{};

String ISO8859_13::name() const {
    return "ISO-8859-13";
}

Charset::ErrorAction ISO8859_13::malformedAction() const {
    return Charset::malformedAction();
}

Charset::ErrorAction ISO8859_13::unmappableAction() const {
    return Charset::unmappableAction();
}

Charset::CoderResult ISO8859_13::decodeLoop(ByteBuffer &src, CharBuffer &dst) {
...
Charset::CoderResult ISO8859_13::encodeLoop(CharBuffer &src, ByteBuffer &dst) {
    struct Surrogate {
        gint& errorLength;
        gint isPair = false;
...
gfloat ISO8859_13::averageCharsPerByte() const {
    return 1.0f;
}

gfloat ISO8859_13::averageBytesPerChar() const {
    return 1.0f;
}

CharBuffer ISO8859_13::decode(ByteBuffer &in) {
    return Charset::decode(in);
}

ByteBuffer ISO8859_13::encode(CharBuffer &in) {
    return Charset::encode(in);
}

String ISO8859_13::toString() const {
    return Charset::toString();
}

gbool ISO8859_13::contains(const Charset &cs) const {
    return dynamic_cast<ISO8859_13 const *>(&cs);
}

gbool ISO8859_13::canEncode(gchar c) const {
    return Charset::canEncode(c);
}

Object &ISO8859_13::clone() const {
    return INSTANCE;
}
