...
Charset::ErrorAction UTF32BE::malformedAction() const {
    return Charset::malformedAction();
}

Charset::ErrorAction UTF32BE::unmappableAction() const {
...
CharBuffer UTF32BE::decode(ByteBuffer &in) {
    return Charset::decode(in);
}

ByteBuffer UTF32BE::encode(CharBuffer &in) {
    return Charset::encode(in);
}

String UTF32BE::toString() const {
    return Charset::toString();
}

gbool UTF32BE::canEncode(gchar c) const {
    return Charset::canEncode(c);
}

gbool UTF32BE::contains(const Charset &cs) const {
