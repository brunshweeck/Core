...
IBM852::IBM852() : Charset("ISO-8859-2") {}
...
Charset::ErrorAction IBM852::malformedAction() const {
    return Charset::malformedAction();
}

Charset::ErrorAction IBM852::unmappableAction() const {
...
CharBuffer IBM852::decode(ByteBuffer &in) {
    return Charset::decode(in);
}

ByteBuffer IBM852::encode(CharBuffer &in) {
    return Charset::encode(in);
}

String IBM852::toString() const {
...
gbool IBM852::canEncode(gchar c) const {
