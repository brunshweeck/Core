...
ISO8859_16::ISO8859_16() : Charset("ISO-8859-16") {}

ISO8859_16 ISO8859_16::INSTANCE{};

String ISO8859_16::name() const {
    return "ISO-8859-16";
}

Charset::ErrorAction ISO8859_16::malformedAction() const {
    return Charset::malformedAction();
}

Charset::ErrorAction ISO8859_16::unmappableAction() const {
    return Charset::unmappableAction();
}

Charset::CoderResult ISO8859_16::decodeLoop(ByteBuffer &src, CharBuffer &dst) {
...
Charset::CoderResult ISO8859_16::encodeLoop(CharBuffer &src, ByteBuffer &dst) {
    struct Surrogate {
...
gfloat ISO8859_16::averageCharsPerByte() const {
    return 1.0f;
}

gfloat ISO8859_16::averageBytesPerChar() const {
    return 1.0f;
}

CharBuffer ISO8859_16::decode(ByteBuffer &in) {
    return Charset::decode(in);
}

ByteBuffer ISO8859_16::encode(CharBuffer &in) {
    return Charset::encode(in);
}

String ISO8859_16::toString() const {
    return Charset::toString();
}

gbool ISO8859_16::contains(const Charset &cs) const {
    return dynamic_cast<ISO8859_16 const *>(&cs);
}

gbool ISO8859_16::canEncode(gchar c) const {
    return Charset::canEncode(c);
}

Object &ISO8859_16::clone() const {
    return INSTANCE;
}
