...
ISO8859_15::ISO8859_15() : Charset("ISO-8859-15") {}

ISO8859_15 ISO8859_15::INSTANCE{};

String ISO8859_15::name() const {
    return "ISO-8859-15";
}

Charset::ErrorAction ISO8859_15::malformedAction() const {
    return Charset::malformedAction();
}

Charset::ErrorAction ISO8859_15::unmappableAction() const {
    return Charset::unmappableAction();
}

Charset::CoderResult ISO8859_15::decodeLoop(ByteBuffer &src, CharBuffer &dst) {
...
Charset::CoderResult ISO8859_15::encodeLoop(CharBuffer &src, ByteBuffer &dst) {
    struct Surrogate {
        gint& errorLength;
        gint isPair = false;
...
gfloat ISO8859_15::averageCharsPerByte() const {
    return 1.0f;
}

gfloat ISO8859_15::averageBytesPerChar() const {
    return 1.0f;
}

CharBuffer ISO8859_15::decode(ByteBuffer &in) {
    return Charset::decode(in);
}

ByteBuffer ISO8859_15::encode(CharBuffer &in) {
    return Charset::encode(in);
}

String ISO8859_15::toString() const {
    return Charset::toString();
}

gbool ISO8859_15::contains(const Charset &cs) const {
    return dynamic_cast<ISO8859_15 const *>(&cs);
}

gbool ISO8859_15::canEncode(gchar c) const {
