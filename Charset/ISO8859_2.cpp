...
ISO8859_2::ISO8859_2() : Charset("ISO-8859-2") {}
...
CharBuffer ISO8859_2::decode(ByteBuffer &in) {
    return Charset::decode(in);
}

ByteBuffer ISO8859_2::encode(CharBuffer &in) {
    return Charset::encode(in);
}

String ISO8859_2::toString() const {
...
gbool ISO8859_2::canEncode(gchar c) const {
