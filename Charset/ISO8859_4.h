...
#ifndef CORE_ISO8859_4_H
#define CORE_ISO8859_4_H


#include "Charset.h"

class ISO8859_4 final: public Charset {
private:
    CORE_EXPLICIT ISO8859_4();
...
public:
    ...
    static ISO8859_4 INSTANCE;
};


#endif //CORE_ISO8859_4_H
