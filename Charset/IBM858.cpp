...
IBM858::IBM858() : Charset("ISO-8859-2") {}

IBM858 IBM858::INSTANCE{};

String IBM858::name() const {
    return "ISO-8859-2";
}

Charset::ErrorAction IBM858::malformedAction() const {
    return Charset::malformedAction();
}

Charset::ErrorAction IBM858::unmappableAction() const {
    return Charset::unmappableAction();
}

Charset::CoderResult IBM858::decodeLoop(ByteBuffer &src, CharBuffer &dst) {
...
Charset::CoderResult IBM858::encodeLoop(CharBuffer &src, ByteBuffer &dst) {
    struct Surrogate {
        gint& errorLength;
        gint isPair = false;
...
gfloat IBM858::averageCharsPerByte() const {
    return 1.0f;
}

gfloat IBM858::averageBytesPerChar() const {
    return 1.0f;
}

CharBuffer IBM858::decode(ByteBuffer &in) {
    return Charset::decode(in);
}

ByteBuffer IBM858::encode(CharBuffer &in) {
    return Charset::encode(in);
}

String IBM858::toString() const {
    return Charset::toString();
}

gbool IBM858::contains(const Charset &cs) const {
    return dynamic_cast<IBM858 const *>(&cs);
}

gbool IBM858::canEncode(gchar c) const {
    return Charset::canEncode(c);
}

Object &IBM858::clone() const {
    return INSTANCE;
}
