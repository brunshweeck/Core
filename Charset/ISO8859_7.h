...
#ifndef CORE_ISO8859_7_H
#define CORE_ISO8859_7_H


#include "Charset.h"

class ISO8859_7 final: public Charset {
private:
    CORE_EXPLICIT ISO8859_7();
...
public:
    ...
    static ISO8859_7 INSTANCE;
};


#endif //CORE_ISO8859_7_H
